//
// Generated file, do not edit! Created by nedtool 5.6 from simple_message.msg.
//
...
int SimpleMessage::getDestination() const
{
    return this->destination;
}

void SimpleMessage::setDestination(int destination)
{
